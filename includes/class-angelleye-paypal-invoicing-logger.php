 ...
 *
 * @class       AngellEYE_PayPal_Invoicing_Logger
 * @version	1.0.0
 * @package	angelleye-paypal-invoicing/includes
 * @category	Class
...
class AngellEYE_PayPal_Invoicing_Logger {
    ...
    private function open($handle) {
        ...
        if ($this->_handles[$handle] = @fopen($this->angelleye_paypal_invoicing_get_log_file_path($handle), 'a')) {
            return true;
        }
